...
public class IdentityEvaluationControl extends HttpServlet 
{
...
public IdentityEvaluationControl(){
jotted( "IdentityEvaluationControl servlet construction and orientation, " + new java.util.Date().toString() );
}
...
public void init( ServletConfig config ) throws ServletException {
	  ...
	  jotted( "IdentityEvaluationControl " + new java.util.Date().toString() );
...
protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {	
	  ...
	  System.out.println("\n\n\t<IdentityEvaluationControl.doPost with the "+request.getSession().getId()+" seesion>\n");

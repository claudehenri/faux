...
java.lang.Object publicID = session.getAttribute("PUBLIC_IDENTITY");
...
if(publicID!=null) identity = "<font color=\"" + publicColor +"\">" + publicID + "</font>";
%>
</head>
<body>
...
<section class="engine"><a rel="external" href="https://mobirise.com">Web Page Maker</a></section><section class="mbr-section mbr-section-hero mbr-section-full mbr-parallax-background mbr-section-with-arrow mbr-after-navbar" id="header1-o" style="background-image: url(assets/images/herpywhooves-vhs-signature.gif);">
        ...
        <div class="container">
            <div class="row">
                <div class="mbr-section col-md-10 col-md-offset-1 text-xs-center">
                    ...
                    <h1 class="mbr-section-title display-1">You are registered&nbsp;<a href="index.jsp"><%=identity%>!</a><br></h1>
					<h4><font size=3 color="<%=publicColor%>"> <%=theDate.toString()%></font></h4>
                </div>
            </div>
        </div>
    </div>

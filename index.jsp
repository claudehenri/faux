...
<section class="mbr-section mbr-section-hero mbr-section-full mbr-parallax-background mbr-section-with-arrow mbr-after-navbar" id="header1-0" style="background-image: url(assets/images/tumblr-okqv70zlqb1u773j8o1.gif);">
        ...
        <div class="container">
            <div class="row">
                <div class="mbr-section col-md-10 col-md-offset-1 text-xs-center">
                    ...
                    <h1 class="mbr-section-title display-1"><p>&nbsp;Real to Reel Excitement</p></h1>
                    <p class="mbr-section-lead lead"></p>
                    <div class="mbr-section-btn">
					<a class="btn btn-lg btn-white" href="https://www.facebook.com/DogparksandCoffeeShops/videos/1553812024832666/">"Dog Parks &amp; Coffee Shops"</a> 
					<a class="btn btn-lg btn-black" href="https://vimeo.com/106674926">"An Unexpected History"</a> 					
                </div>
</BR>
<P>
